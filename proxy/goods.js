...
exports.update = function(goods_id, name, desc, content, image_url, brand_id, active, tag, callback){
  Goods.update({_id: goods_id}, {name: name, desc: desc, content: content, image_url: image_url, brand_id: brand_id, active: active, tag: tag, updated_at: new Date()}, callback);
}; 

exports.update_type = function(goods_ids, type, callback){
  Goods.update({_id: {$in: goods_ids}}, {type: type, updated_at: new Date()}, {multi: true}, callback);
}; 
...
exports.newAndSave = function (name, desc, content, image_url, brand_id, tag, callback) {
  var goods = new Goods();
  goods.name = name;
  goods.desc = desc;
